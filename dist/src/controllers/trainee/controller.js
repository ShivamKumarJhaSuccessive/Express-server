...
class trainees {
    get(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const data1 = yield seedData_1.traineeRepository.findAll(searchQuery).select(role).limit(limit).skip(skip).sort([[sortByDate], [sortByName], [sortByEmail]]);
                const allTraineesCount = yield seedData_1.traineeRepository.countDoc({});
    ...
    post(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const userData = yield seedData_1.traineeRepository.createDoc(newUser);
